...
export default function Home({ onNavigate, userPlan, isLoggedIn = false }) {
    ...
    const services = [
        ...
        },
        {
            ...
            action: () => handleServiceClick(() => onNavigate('coming-soon', 'Speech to Text'))
        },
        {
            id: 'cloning',
            title: 'Voice Cloning',
            ...
            action: () => handleServiceClick(() => onNavigate('coming-soon', 'Voice Cloning'))
        },
        {
            id: 'image',
            title: 'AI Image Gen',
            ...
            action: () => handleServiceClick(() => onNavigate('coming-soon', 'AI Image Generation'))
        }
    ];
